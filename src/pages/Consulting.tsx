...
const ENGAGEMENT = [
  ...
  },
  {
    n: "03",
    t: "Harden",
    d: "Evaluation, observability, cost and latency tuning, human-review workflows, security and audit posture.",
  },
  {
    n: "04",
    t: "Operate",
    d: "You keep it, we support it. Runbooks, monitoring and a support relationship sized to what you actually need.",
  },
];
      ...
      <Page>
        <section className="max-w-5xl mx-auto px-6 pt-20 pb-16">
          ...
          <p className="mt-6 text-base text-foreground/70 max-w-2xl leading-relaxed">
            We deliver AI outcomes and custom software for teams that need working systems, not
            slideware — from proof of concept and MVP through to multi-location, multi-tenant
            enterprise deployments. Everything ships end-to-end on our own infrastructure and
            open-source private inference — the same stack that runs DcernX.
          </p>
              ...
              <div className="bg-background p-8 md:p-10 grid md:grid-cols-5 gap-8 items-start">
                ...
                <div className="md:col-span-3">
                  <p className="text-sm text-foreground/70 leading-relaxed mb-5">
                    A model on its own isn't a product. We build the systems the models live inside
                    — from proof of concept and MVP through to multi-location, multi-tenant
                    enterprise platforms that are self-scaling, resource-lean and secure by design.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {[
        ...
        <section className="border-t border-border/40">
          <div className="max-w-5xl mx-auto px-6 py-20">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-border/40">
              {[
                {
                  k: "Scale-ups & mid-market",
                  v: "Teams past product-market fit that need AI or a platform to unlock the next order of magnitude.",
                },
                {
                  k: "Enterprises with constraints",
                  v: "Regulated, data-sensitive, or on-prem environments where private inference isn't optional.",
                },
                {
                  k: "Funds & investors",
                  v: "Private-market teams standardising diligence and portfolio operations — often via DcernX.",
                },
                {
                  k: "Founders with a workflow-heavy product",
                  v: "AI-native products that would take 18 months to build from scratch — and 3 on Xylor.",
                },
                {
                  k: "Operations & back-office leaders",
                  v: "Real automation of high-volume, judgement-heavy work with auditability the compliance team accepts.",
                },
                {
                  k: "Not a fit",
                  v: "Chatbot experiments, AI-for-AI's-sake, and anyone allergic to evidence and evaluation.",
                },
              ].map((s) => (
        ...
        <section className="border-t border-border/40">
          <div className="max-w-3xl mx-auto px-6 py-24 text-center">
            ...
            <p className="text-sm text-foreground/65 max-w-xl mx-auto mb-10">
              We run a small number of engagements at a time — chosen for fit, not for logo count. A
              30-minute call is enough to tell if we're right for each other.
            </p>
            <a
              href="mailto:hudson@p101limited.com?subject=Consulting%20discovery%20call"
              className="h-11 px-6 inline-flex items-center gap-2 bg-foreground text-background text-sm hover:opacity-90"
