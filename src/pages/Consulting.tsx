...
const DISCIPLINES = [
  { icon: Sparkles, title: "Agentic AI", body: "Multi-agent systems that plan, research, use tools and produce reviewable outputs — with orchestration, evaluation and guardrails we've hardened on our own products.", examples: ["Analyst workflows", "Back-office automation", "Research pipelines"] },
  { icon: Layers, title: "Generative AI", body: "Retrieval-augmented applications with citations, evaluation harnesses and human-in-the-loop review. Not chatbots — production systems.", examples: ["Domain copilots", "Document generation", "Knowledge assistants"] },
  { icon: Eye, title: "Computer vision", body: "Detection, OCR, scene understanding and visual QA deployed on modest hardware — including at the edge where cloud latency isn't an option.", examples: ["Quality inspection", "Document capture", "Physical-world monitoring"] },
  { icon: LineChart, title: "Predictive AI", body: "Classical and modern ML for scoring, forecasting, propensity and anomaly detection — the unglamorous models that quietly move the P&L.", examples: ["Risk scoring", "Demand forecasting", "Anomaly detection"] },
];

const ENGAGEMENT = [
  { n: "01", t: "Discovery", d: "One or two working sessions to frame the problem, the data, the constraints and what 'shipped' actually looks like." },
  { n: "02", t: "Prototype", d: "A working system on Xylor and our private-inference stack within weeks — not a slide deck, not a POC that dies in a demo." },
  { n: "03", t: "Harden", d: "Evaluation, observability, cost and latency tuning, human-review workflows, security and audit posture." },
  { n: "04", t: "Operate", d: "You keep it, we support it. Runbooks, monitoring and a support relationship sized to what you actually need." },
];
  ...
  return (
    <>
      <SEO
        ...
        description="P101's consulting arm delivers agentic, generative, computer vision and predictive AI systems, plus custom software from POC to enterprise — highly scalable, resource-lean and secure, on our own infrastructure and open-source private inference models."
        meta={[
          { property: "og:title", content: "AI Consulting — P101 Limited" },
          { property: "og:description", content: "Agentic, generative, computer vision and predictive AI — plus custom solutions from MVP to multi-tenant enterprise — delivered on our own private-inference stack." },
        ]}
      />
      <Page>
        <section className="max-w-5xl mx-auto px-6 pt-20 pb-16">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="mailto:hudson@p101limited.com?subject=Consulting%20discovery%20call" className="h-11 px-6 inline-flex items-center gap-2 bg-foreground text-background text-sm hover:opacity-90">
              Book a discovery call <ArrowRight className="h-3.5 w-3.5" />
            </a>
            <a href="#how-we-engage" className="h-11 px-6 inline-flex items-center text-sm border border-foreground/20 hover:border-foreground/60 transition-colors">
              How we engage
            </a>
          </div>
        </section>
        ...
        <section className="border-t border-border/40">
          <div className="max-w-5xl mx-auto px-6 py-20">
            ...
            <h2 className="text-3xl md:text-4xl font-light tracking-tight max-w-3xl mb-10">
              Four AI disciplines. <span className="text-foreground/55">One delivery team.</span>
            </h2>
                ...
                return (
                  <div key={d.title} className="bg-background p-7">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {d.examples.map((e) => (
                        <span key={e} className="text-[11px] px-2 py-1 border border-border/60 text-foreground/70">{e}</span>
                      ))}
                    </div>
                  </div>
                );
              ...
              <div className="bg-background p-8 md:p-10 grid md:grid-cols-5 gap-8 items-start">
                <div className="md:col-span-2">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="text-[10px] uppercase tracking-[0.22em] text-foreground/50">And the software around it</div>
                  </div>
                  <div className="text-2xl md:text-3xl font-light tracking-tight">
                    Custom solutions. <span className="text-foreground/55">POC to enterprise.</span>
                  </div>
                </div>
        ...
        <section className="border-t border-border/40">
          <div className="max-w-5xl mx-auto px-6 py-20 grid md:grid-cols-3 gap-px bg-border/40">
            <Stat k="Resource-lean" v="We tune for smaller models and honest inference costs — not the biggest bill in the room." />
            <Stat k="Private by default" v="Open-source models on our own infrastructure. Your data never trains a third-party product." />
            <Stat k="Product DNA" v="We run our own software. The same rigour that ships DcernX shows up on your engagement." />
          </div>
        </section>
        ...
        <section className="border-t border-border/40">
          <div className="max-w-5xl mx-auto px-6 py-20">
            ...
            <h2 className="text-3xl md:text-4xl font-light tracking-tight max-w-3xl mb-10">
              Operators with a real problem. <span className="text-foreground/55">Not experiments in search of a use case.</span>
            </h2>
        ...
        <section id="how-we-engage" className="border-t border-border/40 scroll-mt-16">
          <div className="max-w-5xl mx-auto px-6 py-20">
            ...
            <h2 className="text-3xl md:text-4xl font-light tracking-tight max-w-3xl mb-10">Four phases. No slide-ware.</h2>
        ...
        <section className="border-t border-border/40">
          <div className="max-w-3xl mx-auto px-6 py-24 text-center">
            ...
            <h2 className="text-3xl md:text-5xl font-light tracking-tight mb-6">Bring us the problem.</h2>
