...
const TEAM = [
  { initial: "C", name: "Christian Kumar", role: "Chief Executive Officer", linkedin: "https://www.linkedin.com/in/christiankumar/" },
  { initial: "H", name: "Hudson Paul", role: "Chief Operating Officer", linkedin: "https://www.linkedin.com/in/hudsonpaul1/" },
  { initial: "J", name: "John Swaroop", role: "Chief Technology Officer", linkedin: "https://www.linkedin.com/in/john-swaroop-4389961b7/" },
  { initial: "L", name: "Luke Anglin", role: "Chief Revenue Officer", linkedin: "https://www.linkedin.com/in/lukeanglin/" },
  { initial: "R", name: "Reuel Philip", role: "Product Specialist", linkedin: "https://www.linkedin.com/in/reuel-philip/" },
  { initial: "+", name: "Others", role: "Technology · Design · Data · Security · DevOps · Growth", linkedin: null as string | null },
];
    ...
    <>
      <SEO
        ...
        meta={[
          ...
          { property: "og:description", content: "A UK applied-AI company building products and delivering client outcomes on our own private-inference stack." },
        ]}
      />
      <Page>
        <section className="max-w-3xl mx-auto px-6 pt-20 pb-16">
          ...
          <div className="mt-10 space-y-6 text-base text-foreground/75 leading-relaxed">
            <p>We build software that operates — not proofs of concept — and deliver it on our own private-inference infrastructure.</p>
            <p>
              We own two products.{" "}
              ...
              <Link to="/ventures#xylor" className="underline underline-offset-4 decoration-foreground/30 hover:decoration-foreground">Xylor</Link>{" "}
              is the configurable embedded-AI platform underneath it — and behind every consulting engagement we run.
            </p>
            <p>Our consulting arm develops highly scalable, resource-lean AI outcomes and custom software solutions across agentic, generative, computer vision and primary predictive AI — from POC and MVP to multi-location, multi-tenant enterprise systems. We work with teams who need AI and software to be a system, not a slide.</p>
            <p>We take on select engagements, chosen for fit. We build with open-source models on infrastructure we control. Your data doesn't train someone else's product.</p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-px bg-border/40">
              {TEAM.map((member) => (
                <div key={member.name} className="bg-background p-5">
                  ...
                  {member.linkedin ? (
                    <a href={absoluteLinkedInUrl(member.linkedin)} target="_blank" rel="noopener noreferrer" className="text-sm font-medium hover:underline" aria-label={`${member.name} on LinkedIn`}>
                      {member.name}
                    </a>
                  ) : (
                  ...
                  {member.linkedin && (
                    <a href={absoluteLinkedInUrl(member.linkedin)} target="_blank" rel="noopener noreferrer" className="mt-2 inline-flex items-center gap-1 text-[11px] text-foreground/60 hover:text-foreground" aria-label={`${member.name} on LinkedIn`}>
        ...
        <section className="border-t border-border/40">
          <div className="max-w-3xl mx-auto px-6 py-20 text-center">
            ...
            <Link to="/contact" className="h-11 px-6 inline-flex items-center gap-2 bg-foreground text-background text-sm hover:opacity-90">
