      ...
      <Page>
        <section className="max-w-3xl mx-auto px-6 pt-20 pb-16">
          ...
          <p className="mt-6 text-base text-foreground/70 leading-relaxed max-w-xl">
            The fastest way to reach P101 is a direct email. Tell us what you're trying to solve,
            who it's for and any constraints we should know about. We reply personally.
          </p>
...
function ContactCard({
  ...
  return href ? (
    <a
      ...
      className="block hover:bg-foreground/[0.03] transition-colors"
    >
      {inner}
    </a>
  ) : (
