  ...
  return (
    <>
      <SEO
        ...
        description="Get in touch with P101 Limited about consulting engagements, DcernX, Xylor or partnerships."
        meta={[
          { property: "og:title", content: "Contact — P101 Limited" },
          { property: "og:description", content: "Talk to P101 Limited about consulting, DcernX, Xylor or partnerships." },
        ]}
      />
      <Page>
        <section className="max-w-3xl mx-auto px-6 pt-20 pb-16">
          <EyebrowLabel>Contact</EyebrowLabel>
          <h1 className="text-4xl md:text-6xl font-light tracking-tight leading-[1.05]">Start a conversation.</h1>
          ...
          <div className="mt-12 grid sm:grid-cols-2 gap-px bg-border/40 border border-border/40">
            <ContactCard icon={Mail} label="Consulting, press & partnerships" value="hudson@p101limited.com" sub="We reply personally, usually within one working day." href="mailto:hudson@p101limited.com" />
            <ContactCard icon={Building2} label="Products" value="DcernX · Xylor" sub="dcernx.com" href="https://dcernx.com" />
            <ContactCard icon={MapPin} label="UK office" value="Milton Keynes, United Kingdom" sub="P101 Limited" />
            <ContactCard icon={MapPin} label="US office" value="Sheridan, Wyoming, USA" sub="P101 LLC" />
            <ContactCard icon={Mail} label="Careers & collaborations" value="Introduce yourself" sub="Send a short note and a link — CV, GitHub, portfolio." href="mailto:hudson@p101limited.com?subject=Introduction" />
          </div>
  ...
  const inner = (
    <div className="bg-background p-6 h-full">
      <div className="flex items-center gap-2 mb-4">
        ...
        <div className="text-[10px] uppercase tracking-[0.22em] text-foreground/50">{label}</div>
      </div>
